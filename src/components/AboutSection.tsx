...
import capetown from '../../public/galeeria1101.jpeg.jpeg'; // ✅ corrigido .jpeg.jpeg
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-16 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-left sm:text-center lg:text-left text-sm sm:text-lg mb-4 sm:mb-8 leading-relaxed">
              {t('about.description') ||
                'Not only can university offer an environment rich in our social and cultural experiences.'}
            </p>

            <Link to="/about">
              <Button className="bg-orange-500 hover:bg-orange-400 text-white px-4 sm:px-8 py-6 rounded-lg font-semibold h-9">
